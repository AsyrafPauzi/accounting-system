                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" value={data.tin} onChange={e => setData('tin', e.target.value)} className={inputClass} required />
                            {errors.tin && <p className="text-rose-500 text-xs font-medium mt-1">{errors.tin}</p>}
                        </div>
                        <div>
                            <label className={labelClass}>SSM BRN</label>
                            <input type="text" value={data.brn} onChange={e => setData('brn', e.target.value)} className={inputClass} required />
