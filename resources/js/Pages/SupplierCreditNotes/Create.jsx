...
export default function Create({ auth, suppliers = [], expenseAccounts = [], bill = null, next_number }) {
    ...
    return (
        <AuthenticatedLayout
            ...
            header={
                <DocumentFormHeader
                    ...
                    title="Issue supplier credit note"
                    subtitle="Reduce what you owe the supplier"
                    formId="scn-create-form"
        ...
        >
            ...
            <form id="scn-create-form" className="space-y-6 pb-12 min-w-0" onSubmit={submit}>
                <div className="bg-surface p-6 rounded-2xl border border-border-warm/80 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-5 items-start">
                        <div className="min-w-0">
                            ...
                            <div className={inputReadonlyClass}>{data.scn_number}</div>
                        </div>
                ...
                <DocumentFormNotesTotals
                    bannerTitle="Reduces payable"
                    bannerText="This credit reduces what you owe the supplier."
