        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                    <div>
                        <h2 className="text-2xl lg:text-3xl font-display font-medium text-ink tracking-tight">Batch estimates</h2>
                        <p className="text-ink-muted text-sm font-medium mt-1">
                            Each row creates one draft quote with a single line — no ledger posting until you convert
                        </p>
                    </div>
                ...
                <div className="bg-surface rounded-2xl border border-border-warm/80 shadow-sm overflow-hidden">
                    <div className="px-4 sm:px-5 py-3 border-b border-border-warm bg-cream/50 flex items-center justify-between gap-3">
                        <div>
                            ...
                            <p className="text-xs text-ink-muted mt-0.5">Customer, description, qty, price, and tax per estimate</p>
                        </div>
                        <button
                            type="button"
                            onClick={addRow}
                                ...
                                <div className="flex items-center justify-between gap-2">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button
                                            ...
                                            aria-label={`Remove estimate row ${i + 1}`}
                                        >
                                            Remove
                                        </button>
                                    </div>
