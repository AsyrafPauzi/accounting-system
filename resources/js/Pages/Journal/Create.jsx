                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                    <div className="flex items-start sm:items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-2xl lg:text-3xl font-bold text-slate-900 tracking-tight">New Journal Entry</h2>
                                <p className="text-slate-500 text-sm font-medium mt-1">Record a manual double-entry transaction</p>
                            </div>
                        </div>
                    </div>
