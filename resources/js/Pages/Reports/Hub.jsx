...
const reportCards = [
    ...
    },
    {
        ...
        description: 'Paid vs unpaid revenue per customer for any date range.',
        routeName: 'reports.income-by-customer.index',
        permission: 'reports.sales',
        Icon: Icons.Users,
        accent: 'forest',
    },
    {
        ...
        description: 'Open credit notes / deposits held on customer accounts.',
        routeName: 'reports.customer-credits.index',
        permission: 'reports.customer-credits',
        Icon: Icons.Users,
        accent: 'mustard',
    },
    {
        title: 'Purchases by Vendor',
        description: 'Total spend per supplier with paid vs unpaid breakdown.',
        routeName: 'reports.purchases-by-vendor.index',
        permission: 'reports.purchases-by-vendor',
        Icon: Icons.ChartBar,
        accent: 'ink',
    },
    {
        title: 'Sales Tax Report',
        description: 'Output tax collected vs input tax paid — what you owe.',
        routeName: 'reports.sales-tax.index',
        permission: 'reports.sales-tax',
        Icon: Icons.Document,
        accent: 'terracotta',
    },
    {
