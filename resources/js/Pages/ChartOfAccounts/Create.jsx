        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 className="text-2xl lg:text-3xl font-bold text-slate-900 tracking-tight">Add account</h2>
                        <p className="text-slate-500 text-sm font-medium mt-1">Create a new account in the chart of accounts</p>
                    </div>
                    <Link
