...
export default function Create({ auth, accounts = [] }) {
    ...
    return (
        <AuthenticatedLayout
            ...
            header={
                <DocumentFormHeader
                    ...
                    title="Add account"
                    subtitle="Create a new account in your chart"
                    formId="coa-create-form"
        ...
        >
            ...
            <form id="coa-create-form" onSubmit={submit} className="space-y-6">
                <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] gap-6 items-start">
                    <div className="bg-surface p-6 sm:p-8 rounded-2xl border border-border-warm/80 shadow-sm space-y-6">
                        <div>
                            ...
                            <p className="text-sm text-ink-muted mt-1">Set the code, name, and classification used in reports and posting.</p>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-surface rounded-2xl border border-border-warm/80 shadow-sm p-5">
                            <p className="text-[10px] font-semibold uppercase tracking-wider text-ink-muted">Common examples</p>
                            <ul className="mt-3 space-y-2 text-sm text-ink-muted">
                                <li><span className="font-mono text-ink">1100</span> Accounts Receivable</li>
                                <li><span className="font-mono text-ink">1200</span> Bank</li>
                                <li><span className="font-mono text-ink">2110</span> Accounts Payable</li>
                                <li><span className="font-mono text-ink">4000</span> Revenue</li>
                                <li><span className="font-mono text-ink">5000</span> Expenses</li>
                            </ul>
                        </div>
                    </div>
                </div>
