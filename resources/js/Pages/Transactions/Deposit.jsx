            ...
            <form id="bank-deposit-form" onSubmit={(e) => { e.preventDefault(); post(route('transactions.deposit.store')); }} className="space-y-6 pb-12 min-w-0">
                <div className="bg-surface p-6 rounded-2xl border border-border-warm/80 shadow-sm">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="font-semibold text-ink text-sm uppercase tracking-wider">Deposit details</h3>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-5 items-start">
                        ...
                        <div className="md:col-span-2 min-w-0">
                            <label className={labelClass}>Category (where did it come from?)</label>
                            ...
                            <p className="mt-1.5 text-[11px] text-ink-muted">Revenue for sales · Equity for an owner contribution · Liability for a loan received.</p>
                        </div>
                        <div className="md:col-span-2 min-w-0">
                ...
                <div className="bg-surface-alt border border-border-warm/80 p-6 rounded-2xl shadow-sm">
                    ...
                    <p className="text-terracotta text-sm leading-relaxed">Debits the bank/cash account and credits the chosen category. The journal shows up in General Ledger and Trial Balance.</p>
                </div>
            </form>
        </AuthenticatedLayout>
    );
