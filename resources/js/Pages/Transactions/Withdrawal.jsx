                ...
                <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] gap-6 items-start">
                    <div className="bg-surface rounded-2xl border border-border-warm/80 shadow-sm overflow-hidden">
                        <div className="px-6 py-5 border-b border-border-warm bg-cream/40">
                            <div className="flex items-center gap-3">
                                <span className="p-2 rounded-xl bg-terracotta/10 text-terracotta"><Icons.ArrowUp /></span>
                                <div>
                                    <h3 className="font-semibold text-ink">Withdrawal details</h3>
                                    <p className="text-sm text-ink-muted mt-0.5">Record one outgoing movement and post it immediately.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className={labelClass}>Withdraw from</label>
                                ...
                                <div>
                                    ...
                                    <p className="mt-1.5 text-[11px] text-ink-muted">Use expense for costs, asset for purchases, liability for repayments, or equity for owner drawings.</p>
                                </div>
                            </div>
                    ...
                    <div className="space-y-4">
                        <div className="bg-surface rounded-2xl border border-border-warm/80 shadow-sm p-5">
                            ...
                            <p className="text-sm text-ink-muted mt-1">{selectedBank?.code ? `${selectedBank.code} — cash will leave this account` : 'This is the cash or bank account that will decrease.'}</p>
                        </div>

                        <div className="bg-surface rounded-2xl border border-border-warm/80 shadow-sm p-5">
                            <p className="text-[10px] font-semibold uppercase tracking-wider text-ink-muted">What gets posted</p>
                            <ul className="mt-3 space-y-2 text-sm text-ink-muted">
                                <li><span className="font-semibold text-ink">Debit</span> the category you selected</li>
                                <li><span className="font-semibold text-ink">Credit</span> the bank or cash account</li>
