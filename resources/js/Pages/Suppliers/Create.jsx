                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" value={data.tin} onChange={e => setData('tin', e.target.value)} className={inputClass} placeholder="Optional" />
                        </div>
                        <div>
                            <label className={labelClass}>BRN</label>
                            <input type="text" value={data.brn} onChange={e => setData('brn', e.target.value)} className={inputClass} placeholder="Optional" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" value={data.segment} onChange={e => setData('segment', e.target.value)} className={inputClass} placeholder="e.g. Office supplies" />
                        </div>
                    </div>
                </div>
