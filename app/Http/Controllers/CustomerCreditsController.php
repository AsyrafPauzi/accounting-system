    ...
    public function index(Request $request): Response
    {
        $rows = DB::table('credit_notes as cn')
            ...
            ->select([
                ...
                DB::raw("SUM(CASE WHEN cn.status = 'applied' THEN cn.total_amount ELSE 0 END) as applied_amount"),
                DB::raw("SUM(CASE WHEN cn.status != 'applied' THEN cn.total_amount ELSE 0 END) as open_amount"),
