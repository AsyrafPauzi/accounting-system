...
class UpdateEstimateRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('estimates.edit');
    }
    ...
    public function rules(): array
    {
        ...
        $estimateId = $this->route('id');

        return [
            'customer_id'                 => 'required|exists:customers,id',
            'estimate_number'             => ['required', 'string', 'max:80', Rule::unique('estimates', 'estimate_number')->ignore($estimateId)->whereNull('deleted_at')],
